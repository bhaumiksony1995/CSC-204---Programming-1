...
//Output : A single integer representing he total umber of seconds in the given number of hours input
	...
	public static void main (String[] args)
		{
			...
			final int MIN_IN_HR = 60;	// constant calue for MIN_IN_HR

			Scanner stdin = new Scanner(System.in);
			System.out.print("Please enter the number of hours: ");

			int hrs = stdin.nextInt();	// Input hrs as a String
